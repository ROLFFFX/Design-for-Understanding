...
kiloton_facts = {
    ...
    49: "Conducted on November 16, 1952, as part of Operation Ivy, it had a yield of about 500 kilotons, which is substantially higher than 49 kilotons but demonstrates the scale of nuclear testing during that era. The evices in this yield range are designed to cause significant destruction over a wide area, capable of devastating a medium to large city.",
...
def display_tnt_image():
    ...
    tooltip_text = f"name:{name}, Country: {country}, Date: {date}, Kilotons of TNT:{kiloton}" if country else "No match found"
...
col1, col2, col3 = st.columns([20, 2, 7])
...
with col3:
    ...
    # Displaying specific fact for the current kiloton value
