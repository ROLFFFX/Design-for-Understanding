...
fig_height = max(800, len(unique_countries) * 40)
fig, ax = plt.subplots(figsize=(fig_width, fig_height/100))
scatter = ax.scatter(grouped_data['month_year'], grouped_data['country_num'], s=grouped_data['yield_upper'], c=grouped_data['country_num'], cmap='viridis', alpha=0.6)
...
ax.set_ylim(-1, len(unique_countries))
